...
DEFAULT_SYSTEM_PROMPT = """You are a professional sales consultant for 'Soluciones Sauco', 
...
class ThreadManager:
    def __init__(self):
        ...
        # Use the global system prompt instead of defining it in the class
        self._init_db()
    ...
    def get_response(self, user_id, message):
        ...
        try:
            ...
            print(f"System message: {CURRENT_SYSTEM_PROMPT[:100]}...")
